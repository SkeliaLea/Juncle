                ...
                <table class="table table-hover" id="feedbackTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php
                                if($row['status'] == 0) {
                                    echo "<td><button class='btn btn-warning markAction' feedbackId='".$row['feedback_id']."'>Mark as Viewed</button></td>";
                                }
                            ?>
                        </tr>
                        <?php 
...
<script type="text/javascript">
        $(document).ready(function() {
                      ...
                      $("#rfWrap").addClass('active_nav_item').removeClass('inActive_nav_item');
