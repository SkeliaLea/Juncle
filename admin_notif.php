...
<body class="body-background">
    ...
    <section class="main_container row wrapper">
        ...
        <div class="col-10">
        <div class="column-display-wrapper bg-white mx-4 my-2 w-90 p-3 rounded shadow-sm">
            <!-- START -->
            ...
            <td>Schedule</td>
                ...
                <td style="text-align:center">
                    <div class="overlay" style="height: -10px; display: true;">
                        ...
                        <button id = "btn1" style="padding:0px 7px 0px 5px" class="btn btn-edit-type"><i class="icon-search"></i>View Details</button>
            ...
            <td>Pick Up</td>
                ...
                <div class="overlay" style="height: -10px; display: true;">
                    ...
                    <button id = "btn2" style="padding:0px 7px 0px 5px" class="btn btn-edit-type"><i class="icon-search"></i>View Details</button>
